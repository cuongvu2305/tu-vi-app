/**
 * Thuật toán lịch âm Việt Nam, dựa trên "Astronomical Algorithms" (Jean Meeus, 1998).
 * Ported from Python: (c) 2006 Ho Ngoc Duc, via lasotuvi (MIT) https://github.com/doanguyen/lasotuvi
 */
...
/**
 * Time of the k-th new moon after the new moon of 1/1/1900 13:52 UTC,
 * measured in Julian day number.
 */
